            ...
            Column(
                ...
                InfoCard(
                    ...
                    BenefitItem(
                        ...
                        text = stringResource(R.string.benefit_itc)
                    )
                    Spacer(modifier = Modifier.height(8.dp))
                    BenefitItem(
                        icon = Icons.Default.CheckCircle,
                        text = stringResource(R.string.benefit_invoice)
                    )
                    Spacer(modifier = Modifier.height(8.dp))
                    BenefitItem(
                        icon = Icons.Default.CheckCircle,
                        text = stringResource(R.string.benefit_accounting)
                    )
                    Spacer(modifier = Modifier.height(8.dp))
                    BenefitItem(
                        icon = Icons.Default.CheckCircle,
                        text = stringResource(R.string.benefit_tax_filing)
                    )
                }
